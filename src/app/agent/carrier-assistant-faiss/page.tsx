...
export default function CarrierAssistantFaissPage() {
  ...
  const { ask, loading, answer, conditions, sources, retrieved } =
    useCarrierAssistant("/api/carrier-assistant-faiss");
      ...
      <div className="mx-auto max-w-6xl space-y-6">
        <header className="flex items-start justify-between">
          <div>
            ...
            <h1 className="text-2xl font-semibold">Carrier Assistant (FAISS)</h1>
            <p className="text-sm text-gray-600">
              FAISS-backed retrieval for carrier eligibility/coverage with citations.
            </p>
          </div>
        </header>
